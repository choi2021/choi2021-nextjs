...
![auth페이지개선](/static/images/2022-10-11-원티드프리온보딩과제-7/auth페이지개선.gif)
...
![todo페이지개선](/static/images/2022-10-11-원티드프리온보딩과제-7/todo페이지개선.gif)
...
![Todo 화면에서 새로고침 후 화면](/static/images/2022-10-11-원티드프리온보딩과제-7/새로고침후화면.png)

​ 생각보다 해결방법은 간단하게 CRA 공식홈페이지 deploy부분에 설명되어있었다.

![deploy 문서내용](/static/images/2022-10-11-원티드프리온보딩과제-7/deploy.png)
