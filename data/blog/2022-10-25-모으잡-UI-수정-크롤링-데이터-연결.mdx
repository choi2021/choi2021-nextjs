...
[개선 UI]
![개선 UI](/static/images/2022-10-25-모으잡-UI-수정-크롤링-데이터-연결/개선UI.png)
그리고 원티드의 포트폴리오 관련 자료를 보다가 서비스를 조금 더 발전 시킬 수 있는 포인트를 얻을 수 있었다.

[원티드 포트폴리오를 부탁해](https://www.wanted.co.kr/events/talk8)

![포트폴리오를 부탁해](/static/images/2022-10-25-모으잡-UI-수정-크롤링-데이터-연결/포트폴리오를부탁해.png)
...
[에러핸들링적용]
![에러적용](/static/images/2022-10-25-모으잡-UI-수정-크롤링-데이터-연결/에러적용.png)
