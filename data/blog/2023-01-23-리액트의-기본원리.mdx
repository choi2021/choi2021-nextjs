...
![react flow](/static/images/2023-01-23-리액트의-기본원리/reactflow.png)
...
![flux](/static/images/2023-01-23-리액트의-기본원리/flux.png)
...
![mvc](/static/images/2023-01-23-리액트의-기본원리/mvc.png)

양방향 데이터바인딩으로 MVC패턴을 사용하던 Facebook은 점점 복잡해지고 예측하지 못하는 단점을 해결하기 위해 단방향 아키택처인 **Flux 패턴**을 도입한다.

![mvc-2](/static/images/2023-01-23-리액트의-기본원리/mvc-2.png)
...
![redux](/static/images/2023-01-23-리액트의-기본원리/redux.webp)
