...
date: 2024-07-06
summary: "react-navigation의 Stack Navigator에서 Native Stack Navigator로 화면전환 성능 개선하기"
...
![당시 기획해두었던 아이디어들](/static/images/2024-06-30-NativeStack적용하기/ideas.png)
...
![react native 공식문서의 Navigating between screens](/static/images/2024-06-30-NativeStack적용하기/react-native-navigating.png)

[[React Navigation v2의 소개된 메모리 사용량 비교 데이터](https://twitter.com/janicduplessis/status/1039979591815897088?s=21)]
![React Navigation v2의 소개된 메모리 사용량 비교 데이터](/static/images/2024-06-30-NativeStack적용하기/x-memory-comparison.png)
...
![expo-router 인트로 섹션](/static/images/2024-06-30-NativeStack적용하기/expo-router.png)
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/js-card-ios.gif" alt="js-card-ios" width="400"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/js-modal-ios.gif" alt="js-modal-ios" width="400"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/js-transparent-ios.gif" alt="js-transparent-ios.gif" width="400"/></td>
  </tr>
</table>
<br/>
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/js-card-android.gif" alt="modal" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/js-modal-android.gif" alt="js-modal-android.gif" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/js-transparent-android.gif" alt="js-transparent-android.gif" width="300"/></td>
  </tr>
</table>
...
<img src="/static/images/2024-06-30-NativeStack적용하기/js-card-modal-push.gif" alt="modal" width="300"/>
...
<table width="100%">
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-card-ios.gif" alt="card" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-modal-ios.gif" alt="modal" width="300"/></td>
  </tr>
  <tr>
 ...
 <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-transparentModal-ios.gif" alt="card" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-containedModal-ios.gif" alt="modal" width="300"/></td>
  </tr>
 <tr>
 ...
 <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-containedTransparentModal-ios.gif" alt="card" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-full-screen-modal-ios.gif" alt="modal" width="300"/></td>
  </tr>
 <tr>
    <th>formSheet</th>
  </tr>
 <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-formsheet-ios.gif" alt="card" width="300"/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-card-android.gif" alt="card" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-modal-android.gif" alt="modal" width="300"/></td>
  </tr>
 <tr>
    <th>transparent modal</th>
    <th>contained modal</th>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-transparentModal-android.gif" alt="card" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-containedModal-android.gif" alt="modal" width="300"/></td>
  </tr>
  <tr>
    <th>contained transparent modal</th>
    <th>fullScreen modal</th>
 ...
 <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-containedTransparentModal-android.gif" alt="card" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-full-screen-modal-android.gif" alt="modal" width="300"/></td>
  </tr>
  <tr>
    <th>formSheet</th>
  </tr>
 <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-formsheet-android.gif" alt="card" width="300"/></td>
  </tr>
</table>
...
<img src="/static/images/2024-06-30-NativeStack적용하기/native-card-modal-push.gif" alt="modal" width="300"/>
...
![React Navigation의 가이드](/static/images/2024-06-30-NativeStack적용하기/modal-best-practice.png)
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/js-card-android.gif" alt="card" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/native-card-android.gif" alt="modal" width="300"/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/stack-modal-ios.gif" alt="card" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/product-modal-ios.gif" alt="card" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/product-modal-android.gif" alt="modal" width="300"/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/stack-modal-ios.gif" alt="card" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/product-formsheet-ios.gif" alt="modal" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/product-formsheet-android.gif" alt="modal" width="300"/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/mimic-fullscreen-issue.gif" alt="modal" width="300"/></td>
  </tr>
</table>
...
![animationDuration 공식문서](/static/images/2024-06-30-NativeStack적용하기/react-navigation-animationDuration.png)
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/js-modal-android.gif" alt="modal" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/android-animation-velocity-before.gif" alt="modal" width="300"/></td>
  </tr>
</table>
...
![React Native Screens로 안내하는 React Navigation 공식문서](/static/images/2024-06-30-NativeStack적용하기/react-native-screens-안내.png)
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/android-animation-velocity-before.gif" alt="modal" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/android-animation-velocity-after.gif" alt="modal" width="300"/></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/signup-modal-issue-before.gif" alt="modal" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/signup-modal-after.gif" alt="modal" width="300"/></td>
  </tr>
</table>
...
![pan responder 주석](/static/images/2024-06-30-NativeStack적용하기/pan-responder.png)
...
<table>
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/customer-home-before.gif" alt="modal" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/customer-home-after.gif" alt="modal" width="300"/></td>
  </tr>
</table>
...
<table width="100%">
  ...
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/flashlight-home.png" alt="modal" width="1000"/></td>
  </tr>
 <tr>
    <th>받은 요청 목록 -> 받은 요청 상세 전/후</th>
  </tr>
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/flashlight-request.png" alt="modal" width="1000"/></td>
  </tr>
 <tr>
    <th>받은 견적 목록 -> 받은 견적 상세 -> 견적서 상세 전/후</th>
  </tr>
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/flashlight-quote.png" alt="modal" width="1000"/></td>
  </tr>
 <tr>
    <th>채팅방 목록 -> 채팅방 AS-IS</th>
  </tr>
  <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/flashlight-chatlist.png" alt="modal" width="1000"/></td>
  </tr>
</table>
...
<table width="100%">
 ...
 <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/android-before-10.gif" alt="modal" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/android-before-50.gif" alt="modal" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/android-before-100.gif" alt="modal" width="300"/></td>
 </tr>
 <tr>
 ...
 <tr>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/android-after-10.gif" alt="modal" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/android-after-50.gif" alt="modal" width="300"/></td>
    <td><img src="/static/images/2024-06-30-NativeStack적용하기/android-after-100.gif" alt="modal" width="300"/></td>
 </tr>
</table>
