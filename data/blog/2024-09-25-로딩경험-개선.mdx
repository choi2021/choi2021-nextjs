...
title: "⏳ 로딩 경험 개선"
date: 2024-09-25
summary: "3분기동안 진행한 로딩경험 개선작업을 정리합니다"
...
<table>
    ...
    <tr>
        <td><img src="/static/images/2024-09-25-로딩경험-개선/100MS_SKELETON.gif" alt="100ms 로딩" /></td>
        <td><img src="/static/images/2024-09-25-로딩경험-개선/300MS_SKELETON.gif" alt="300ms 로딩" /></td>
    </tr>
</table>
...
![전역 로딩으로 인해 깜빡이는 듯한 알림 목록 화면](/static/images/2024-09-25-로딩경험-개선/loading_before.gif)
...
![공식문서 suspense에 대한 Note](/static/images/2024-09-25-로딩경험-개선/suspense-official.png)
...
![Tanstack Query migrate to v5 섹션의 suspense에 대한 노트](/static/images/2024-09-25-로딩경험-개선/migrate_to_v5.png)
...
<img src="/static/images/2024-09-25-로딩경험-개선/suspenseQuery.gif" width="500" />
...
![각각 suspenseQuery를 적용했을 때 길어지는 요청시간](/static/images/2024-09-25-로딩경험-개선/suspenseQueries_before.gif)

이러한 길어지는 요청시간을 개선하기 위해서는 하위 컴포넌트에서 각각 useSuspenseQuery로 호출하게 하거나, **useSuspenseQueries**로 병렬로 호출할 수 있다.

![공식문서 parallel queries 섹션의 suspense 사용시 주의점 노트](/static/images/2024-09-25-로딩경험-개선/parallel_queris.png)
...
![suspenseQueries를 이용해 병렬로 처리한 결과](/static/images/2024-09-25-로딩경험-개선/suspenseQueries_after.gif)
...
<img src="/static/images/2024-09-25-로딩경험-개선/suspenseInfiniteQuery.gif" width="500" />
...
<table width="100%">
    ...
    <tr>
        <td><img src="/static/images/2024-09-25-로딩경험-개선/queryType.png"  /></td>
    </tr>
    <tr>
        <th>useSuspenseQuery 타입 정의</th>
    </tr>
    <tr>
        <td><img src="/static/images/2024-09-25-로딩경험-개선/suspense_query_type.png" /></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><img src="/static/images/2024-09-25-로딩경험-개선/loading_before.gif" alt="기존 로딩 UI" width="332" /></td>
        <td><img src="/static/images/2024-09-25-로딩경험-개선/loading_after.gif" alt="개선된 로딩 UI" width="332" /></td>
    </tr>
    <tr>
        <th>기존 전역 로딩 UI</th>
        <th>개선된 전역 로딩 UI</th>
...
<table>
    ...
    <tr>
        <td><img src="/static/images/2024-09-25-로딩경험-개선/200ms_under.gif" alt="200ms_under" width="332" /></td>
        <td><img src="/static/images/2024-09-25-로딩경험-개선/loading_after.gif" alt="200ms_over" width="332" /></td>
    </tr>
</table>
