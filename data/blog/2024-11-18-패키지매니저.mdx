...
title: "패키지 매니저 비교해보기"
date: 2024-11-18
summary: "패키지 매니저의 역할을 정리해보고 npm, yarn, pnpm, yarn berry에 대해 비교해보자"
...
<img src="/static/images/2024-11-18-패키지매니저/npm.png" alt="npm" />
...
![node_modules...](/static/images/2024-11-18-패키지매니저/node_modules.png)

이렇게 거대해진 `node_modules` 폴더는 프로젝트 크기가 커질수록 CI/CD 과정에서 오래걸리게 되고 시간 뿐 아니라, 큰 용량을 차지하게 된다.

![Ghost Dependencies](/static/images/2024-11-18-패키지매니저/ghost_dependencies.png)
...
![npm-example](/static/images/2024-11-18-패키지매니저/npm-example.png)
...
![npm-ghost-dep](/static/images/2024-11-18-패키지매니저/npm-ghost-dep.png)
...
![yarn-example](/static/images/2024-11-18-패키지매니저/yarn-example.png)
...
![pnpm-disk](/static/images/2024-11-18-패키지매니저/pnpm-disk.png)
...
![pnpm-node-modules](/static/images/2024-11-18-패키지매니저/pnpm-node-modules.png)

앞선 예제를 pnpm 프로젝트에서 설치했을 때 모습이다.

![pnpm-example](/static/images/2024-11-18-패키지매니저/pnpm-example.png)
...
![pnpm-error](/static/images/2024-11-18-패키지매니저/pnpm-error.png)
...
![yarn-pnp-example](/static/images/2024-11-18-패키지매니저/yarn-pnp-example.png)
...
![yarn-pnp-ghost-dep](/static/images/2024-11-18-패키지매니저/yarn-pnp-ghost-dep.png)
