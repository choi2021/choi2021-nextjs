...
date: 2024-11-24
summary: "토스의 Overlay Kit 패키지 코드를 분석해보고 어떻게 동작하는지 알아보자"
...
![state를 직접 관리하는 방식](/static/images/2024-11-24-overlay-kit-분석/demo-state.gif)
...
![overlay kit을 이용한 예시](/static/images/2024-11-24-overlay-kit-분석/demo-overlay.gif)
...
![overlay kit 패키지 구조](/static/images/2024-11-24-overlay-kit-분석/overlay-kit-structure.png)
...
![overlay kit 지원버전](/static/images/2024-11-24-overlay-kit-분석/overlay-kit-support-version.png)
