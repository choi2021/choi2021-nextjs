...
date: 2025-01-19
summary: "새로운 토스의 useFunnel 패키지 코드를 분석해보고 어떻게 동작하는지 알아보자"
...
![작성했던 이전글](/static/images/2025-01-19-useFunnel-분석/useFunnel-previous-cover.png)
...
![뒤로가기 데이터 관리 문제](/static/images/2025-01-19-useFunnel-분석/simple-funnel.png)

이부분을 읽으면서 `이미 선택한 데이터를 다시 선택하지 않아도 되게 해줄 수 있기 위해 이미 선택한 정보는 뒤로가기시에도 보관하는 게 좋지 않을까` 생각이 들었지만 아래와 같은 상황이라면 달라진다.

![복잡한 퍼널에서의 뒤로가기 데이터 관리 문제](/static/images/2025-01-19-useFunnel-분석/complicated-funnel.png)
...
![use-funnel 패키지 구조](/static/images/2025-01-19-useFunnel-분석/use-funnel-structure.png)
...
![core 폴더 구조](/static/images/2025-01-19-useFunnel-분석/core-structure.png)
...
![설치하기의 app router 관련 안내](/static/images/2025-01-19-useFunnel-분석/install.png)
...
![next router push interface](/static/images/2025-01-19-useFunnel-분석/push-interface.png)
...
![query state](/static/images/2025-01-19-useFunnel-분석/query-state.png)
